...
HD_PWD='C:/git/DIDE/dide_fs26/zybo_ps1/vivado/zybo_ps1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_ps1_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_ps1_top.tcl
