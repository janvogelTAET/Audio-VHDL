...
HD_PWD='C:/git/DIDE/dide_fs26/zybo_ps1/vivado/zybo_ps1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_ps1_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_ps1_top.tcl -notrace
